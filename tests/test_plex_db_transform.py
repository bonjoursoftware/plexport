    ...
    assert transform_plex_db(plex_db_export) == [
        {
            ...
            "tags": ["all", "res_1080", "unwatched", "lang_english", "subs_english", "subs_german"],
        ...
        },
        {
            ...
            "tags": ["all", "res_sd", "watched", "lang_fra", "lang_spa", "subs_fra"],
        ...
        },
        {
            ...
            "tags": ["all", "res_hd", "unwatched", "dupe", "lang_und", "subs_xxx"],
        ...
        },
        {
            ...
            "notes": "0h02m03s - 2.0Mbps h999 constrained baseline - 2ch cod pro - 88.6MB /movies/fantastic.mp4",
            "tags": ["all", "res_hd", "unwatched", "dupe"],
